function load() {
  ...
  fetch(re)
    ...
    .then(function (data) {
      ...
      document.getElementById("productName").innerHTML = JSON.stringify(data.id[productID].name);
      ...
      document.getElementById("price").innerHTML = "Price: $" + data.id[productID].price;
      document.getElementById("size").innerHTML = "Size: " + data.id[productID].size;
      document.getElementById("key").innerHTML = "Switch: " + data.id[productID].switch;
